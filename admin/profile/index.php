	...
	<div class="header">
		...
		<div class="header-right">
					...
					<div class="dropdown-menu dropdown-menu-right">
						<div class="notification-list mx-h-350 customscroll">
							<ul>
								...
								<li>
									<a href="#">
										<img src="<?php echo BASE_URL; ?>vendors/images/photo2.jpg" alt="">
								...
								<li>
									<a href="#">
										<img src="<?php echo BASE_URL; ?>vendors/images/photo3.jpg" alt="">
										<h3>John Doe</h3>
										<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed...</p>
									</a>
								</li>
								<li>
									<a href="#">
										<img src="<?php echo BASE_URL; ?>vendors/images/photo4.jpg" alt="">
			...
			<div class="github-link">
				<a href="https://github.com/dropways/deskapp" target="_blank"><img src="<?php echo BASE_URL; ?>vendors/images/github.svg" alt=""></a>
			</div>
		</div>
	</div>
					...
					<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mb-30">
						<div class="pd-20 card-box height-100-p">
							<div class="profile-photo">
								...
								<img src="<?php echo BASE_URL; ?>vendors/images/photo1.jpg" alt="" class="avatar-photo">
